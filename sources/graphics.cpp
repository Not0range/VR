...
#define VERTICLE_SHADER "shaders/shader.vert.spv"
#define FRAGMENT_SHADER "shaders/shader.frag.spv"
...
private:
    void vulkanInit(){
        getInstance(getInstanceInfo(getAppInfo()));
        getSurface();
        getPhisicalDevices();
        getLogicalDevice();
        createSwapChain();
    ...
    void windowInit(){
        ...
        window = glfwCreateWindow(800, 600, APP_SHORT_NAME, nullptr, nullptr);
    ...
    VkInstanceCreateInfo getInstanceInfo(VkApplicationInfo info){
        VkInstanceCreateInfo inst_info = {};
        inst_info.sType = VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO;
        inst_info.pNext = NULL;
        inst_info.flags = 0;
        inst_info.pApplicationInfo = &info;
    ...
    bool isDeviceSuitable(VkPhysicalDevice device) {
        ...
        return familyIndices.allowed() && swapChainAdequate;
    }
    ...
    void getSurface(){//not cross-platform
        VkWin32SurfaceCreateInfoKHR surfaceInfo{};
        surfaceInfo.sType = VK_STRUCTURE_TYPE_WIN32_SURFACE_CREATE_INFO_KHR;
        surfaceInfo.hwnd = glfwGetWin32Window(window);
        surfaceInfo.hinstance = GetModuleHandle(nullptr);
        if (vkCreateWin32SurfaceKHR(inst, &surfaceInfo, nullptr, &surface) != VK_SUCCESS) 
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile(VERTICLE_SHADER);
        ...
        if (vkCreatePipelineLayout(logicalDevice, &pipelineLayoutInfo, 
    ...
    void createSyncObjects() {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
            if (vkCreateSemaphore(logicalDevice, &semaphoreInfo, 
                ...
                vkCreateSemaphore(logicalDevice, &semaphoreInfo, 
